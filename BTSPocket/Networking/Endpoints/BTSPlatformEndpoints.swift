...
class BTSPlatformEndpoints: WSAPI {
    ...
    // MARK: putMethod
    func putMethod<T: Codable>(_ url: String, _ headers: [String : String]? = nil, _ params: Any? = nil, onSuccess: @escaping (T) -> Void, onError: @escaping (_ error: NSError) -> Void) {
        self.request(url,
                     method: .put,
                     parameters: params,
                     headers: headers,
    ...
    // MARK: putMethod
    func deleteMethod<T: Codable>(_ url: String, _ headers: [String : String]? = nil, _ params: Any? = nil, onSuccess: @escaping (T) -> Void, onError: @escaping (_ error: NSError) -> Void) {
        self.request(url,
                     method: .delete,
                     parameters: params,
                     headers: headers,
